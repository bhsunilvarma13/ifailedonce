    ...
    <div className="w-[80vw] mx-auto py-10">
      ...
      <div className="space-y-5 text-lg">
        ...
        <p>
          ...
          defeat. Let's bring history's missteps to the forefront, where they
        ...
        <p>
          ...
          at heart, human. The world's most celebrated figures, be they artists,
          politicians, scientists, or athletes, have all faced moments of
          vulnerability. They've grappled with doubts, made decisions that
          backfired, and stumbled on the path to success.
        </p>
        <p>
        ...
        <p>
          ...
          the reassurance that it is okay to falter on our quest for
          achievement.
        </p>
        <p>
